...
export const eorzeanMap = { pin: (_id: string, _x: number, _y: number) => {}, isLoaded: false };
</script>
...
eorzeanMap.pin = (id: string, x: number, y: number) => {
  mapID.value = id;
  X.value = x;
  Y.value = y;
  close.value = false;
